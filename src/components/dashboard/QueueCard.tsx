      ...
      <Link href={`/queue/${location.id}`} className="block h-full">
        <GlassCard glow={glowType} className="p-5 flex flex-col justify-between h-full group">
          ...
          <div>
            <div className="flex items-start justify-between gap-2 mb-3">
              <div>
                ...
                <h3 className="font-bold text-base text-white group-hover:text-teal-300 transition-colors flex items-center gap-1.5">
                  {location.name}
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3 p-3 rounded-lg bg-slate-950/60 border border-white/5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-[10px] text-slate-400 font-medium uppercase">Queue Count</p>
                  <p className="text-base font-bold text-white">
                    {location.peopleCount} <span className="text-xs font-normal text-slate-400">people</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-[10px] text-slate-400 font-medium uppercase">Est. Wait</p>
                  <p className="text-base font-bold text-white">
                    {location.estimatedWaitMin} <span className="text-xs font-normal text-slate-400">min</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-white/5 text-[11px]">
              <span className="text-slate-400 flex items-center gap-1">
                <Sparkles className="w-3 h-3 text-teal-400" /> Best window:
              </span>
              <span className="text-teal-300 font-semibold truncate max-w-[170px]">
